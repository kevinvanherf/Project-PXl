...
namespace HogeschoolPXL.Controllers
{
    public class GebruikersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GebruikerId,Naam,NaamId,Email")] Gebruiker gebruiker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GebruikerId,Naam,NaamId,Email")] Gebruiker gebruiker)
        {
